...
const mockPrepData: ProfessionalPrepData = {
  document: {
    ...
    documentType: mockDocument.documentType ?? null,
    isStatedType: true,
    parties: mockDocument.parties ?? null,
    governingLaw: mockDocument.governingLaw ?? null,
    jurisdiction: mockDocument.jurisdiction ?? null,
    pageCount: mockDocument.pageCount ?? null,
